...
public class WithdrawMoney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String bank[] = {"Axis Bank", "HDFC Bank", "ICICI Bank", "State Bank Of India",
                "Allahbad Bank", "Bandhan Bank", "Bank Of Baroda", "Canara Bank", "Corporation Bank",
                "IDBI Bank", "Kottak Bank", "Union Bank Of India", "Syndicate Bank", "Yes Bank"};
        Spinner spinner=findViewById(R.id.spinner);
        ArrayAdapter<String> adapter=new ArrayAdapter<>(getApplicationContext(), R.layout.spinner_text,bank);
